...
public class MethodGenerator implements AstVisitor<BtcInstr, BtcMETHOD> {
    ...
    public BtcInstr visit(AstPreExpr preExpr, BtcMETHOD btcMethod) {
        ...
        switch (preExpr.oper) {
            ...
            case PTR -> {
                // TODO: Implement referencing. Maybe not needed.
                System.out.println("HERERE1231313");
                System.out.println(preExpr.subExpr);
                System.out.println(((AstNameExpr)preExpr.subExpr).name);
                return null;
            }
            case ADD -> {
