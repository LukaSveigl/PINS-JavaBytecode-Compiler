...
import pins.data._btc.instr.arithmetic.*;
import pins.data._btc.instr.flow.*;
import pins.data._btc.instr.object.*;
import pins.data._btc.instr.stack.*;
import pins.data._btc.vars.*;
